...
from model.model_superhuman import UNet_PNI, UNetS_PNI
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='devo_3ds', help='path to config file')
...
CUDA_VISIBLE_DEVICES=2 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse.py

CUDA_VISIBLE_DEVICES=0 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse.py -c devo_3ds_t1

CUDA_VISIBLE_DEVICES=1 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse.py -c devo_3ds_t2

CUDA_VISIBLE_DEVICES=0 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse.py -c devo_3ds_t3
'''