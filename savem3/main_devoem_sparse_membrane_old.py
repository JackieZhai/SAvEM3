...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='mem_3ds_t1', help='path to config file')
...
CUDA_VISIBLE_DEVICES=3 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse_membrane.py -c mem_3ds_t1

CUDA_VISIBLE_DEVICES=2 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse_membrane.py -c mem_3ds_t2

CUDA_VISIBLE_DEVICES=2 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse_membrane.py -c mem_3ds_t3
'''