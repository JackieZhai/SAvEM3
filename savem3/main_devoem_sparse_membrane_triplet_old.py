        ...
        if cfg.TRAIN.if_valid:
            if iters % cfg.TRAIN.save_freq == 0 or iters == 1:
                ...
                for k, batch in enumerate(dataloader, 0):
                    ...
                    valid_provider.add_vol(pred.data.cpu().numpy()[0])
...
CUDA_VISIBLE_DEVICES=3 /mnt/WGCJ/miniconda4/envs/micro-sam/bin/python main_devoem_sparse_membrane_triplet.py -c mem3c_3ds_t3
