...
def kimimaro_masks_sample_points(masks, labels_list, interval=5):
    """Sample the points inner the provided masks
    by interval picking from kimimaro skeletonization

    The masks should be in format [N, H, W] where N is the number of masks, (H, W) are the spatial dimensions.
    The labels_list should be in format [N, L] where N is the number of masks, L is the number of labels.

    Returns a [N, L, 2] tensors, with the points in xy format
    """
    pass
