...
def get_args_parser():
    ...
    parser.add_argument("--output", type=str, 
                        default="/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/train/work_dirs/test_HQ_weak", 
                        help="Path to the directory where masks and checkpoints will be output")
...
if __name__ == "__main__":
    ...
    record_train = {"name": "record_train",
                    "path": "/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/cell_part_weak_train.json"}
    record_valid = {"name": "record_valid",
                    "path": "/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/cell_part_weak_val.json"}
