...
class Sam_fast(nn.Module):
    ...
    def forward(
        ...
        # image_embeddings: torch.Size([4, 256, 64, 64]) torch.float32, interm_embeddings[0]: torch.Size([4, 64, 64, 768]) torch.float32
