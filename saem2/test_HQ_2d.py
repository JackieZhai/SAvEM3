...
from utils.dataloader_isbi_test_2d import get_im_gt_name_dict, create_dataloaders
...
def get_args_parser():
    ...
    # parser.add_argument("--restore-model", type=str, 
    #                     default='work_dirs/hq_sam_b_mempro/epoch_11.pth',
    #                     help="The path to the hq_decoder training checkpoint for evaluation")
...
def main(net, train_datasets, valid_datasets, args):
    ...
    if not args.eval:
        ...
        train(args, net, optimizer, train_list_generator, valid_dataloaders, lr_scheduler)
    else:
...
def train(args, net, optimizer, train_list_generator, valid_dataloaders, lr_scheduler):
...
if __name__ == "__main__":
    ...
    record_test = {"name": "record_test",
                    "path": './record2d_test.json'}

    train_datasets = [record_test,]
    valid_datasets = [record_test,] 
