...
class MaskDecoderHQ(MaskDecoder):
    def __init__(self, model_type):
        ...
        checkpoint_dict = {"vit_b":"/home/zhaih/share/SAM/sam-hq-main/train/pretrained_checkpoint/sam_vit_b_maskdecoder.pth",
                           "vit_l":"/home/zhaih/share/SAM/sam-hq-main/train/pretrained_checkpoint/sam_vit_l_maskdecoder.pth",
                           'vit_h':"/home/zhaih/share/SAM/sam-hq-main/train/pretrained_checkpoint/sam_vit_h_maskdecoder.pth"}
...
def get_args_parser():
    ...
    parser.add_argument("--output", type=str, 
                        default="/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/train/work_dirs/test_HQ_elong", 
                        help="Path to the directory where masks and checkpoints will be output")
    parser.add_argument("--model-type", type=str, default="vit_h", 
                        help="The type of model to load, in ['vit_h', 'vit_l', 'vit_b']")
    # parser.add_argument("--checkpoint", type=str, 
    #                     default="/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/train/pretrained_checkpoint/sam_vit_b_01ec64.pth", 
    #                     help="The path to the SAM checkpoint to use for mask generation.")
    parser.add_argument("--checkpoint", type=str, 
                        default="/home/zhaih/share/SAM/sam-hq-main/train/pretrained_checkpoint/sam_vit_h_4b8939.pth", 
                        help="The path to the SAM checkpoint to use for mask generation.")
    ...
    # parser.add_argument("--restore-model", type=str, 
    #                     default='/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/train/work_dirs/hq_sam_b_mempro/epoch_11.pth',
    #                     help="The path to the hq_decoder training checkpoint for evaluation")
...
def evaluate(args, net, sam, valid_dataloaders, visualize=False):
    ...
    for k in range(len(valid_dataloaders)):
        ...
        for data_val in metric_logger.log_every(valid_dataloader,1000):
            ...
            iou = compute_iou(masks_hq + masks_sam, gt_c_val.to(torch.uint8))
            boundary_iou = compute_boundary_iou(masks_hq + masks_sam, gt_c_val.to(torch.uint8))
...
if __name__ == "__main__":
    ...
    record_train = {"name": "record_train",
                    "path": "/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/cell_part_elong_train.json"}
    record_valid = {"name": "record_valid",
                    "path": "/home/guojy2/share/guojy/ProjectCodes/BigModel/sam-hq/cell_part_elong_val.json"}
